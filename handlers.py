...
def start(update, context: CallbackContext) -> int:
    ...
    bot.send_message(
        chat_id=chat_id,
        text= "Howdy, Welcome to BotFather ,"
        "Please tell me about yourself, "
        "provide your full name, email, and phone number, "
        "separated by comma each e.g: "
        "Michael Scott, M.Scott69@gmail.com, +918451972414"
        "Will make you the offer you cant refuse."
    )
    return CHOOSING
...
def classer(update, context):
    ...
    if update.callback_query.data.lower() == "sme":
        ...
        bot.send_message(
            ...
            "Diep, Diepg@gmail.com, address, +918451972414",
